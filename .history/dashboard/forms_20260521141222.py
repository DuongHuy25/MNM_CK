...
class AboutForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['source_type'].initial = 'manual'

        for field_name in ['excerpt', 'featured_image', 'external_link', 'order']:
...
class CustomerProfileForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        for field_name in [
            'phone', 'address', 'avatar', 'birth_date', 'gender',
            'bio', 'website', 'facebook', 'instagram', 'twitter',
            'linkedin', 'preferred_language'
        ]:
            if field_name in self.fields:
                self.fields[field_name].required = False
